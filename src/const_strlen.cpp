...
template<const char *str, int size, char ch> struct strlen_helper : public strlen_helper<str, size + 1, str[size]> {};

template<const char *str, int size> struct strlen_helper<str, size, '\0'> {
